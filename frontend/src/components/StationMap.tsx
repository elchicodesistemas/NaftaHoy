...
const stations = [
  {
    name: "YPF - Av. Libertador 1500",
    brand: "ypf" as BrandId,
    lat: -34.5628,
    lng: -58.4372,
  },
  {
    name: "Shell - Av. Santa Fe 3200",
    brand: "shell" as BrandId,
    lat: -34.5885,
    lng: -58.4098,
  },
  {
    name: "Axion - Av. Córdoba 4500",
    brand: "axion" as BrandId,
    lat: -34.5964,
    lng: -58.4245,
  },
  {
    name: "Puma - Av. Cabildo 2100",
    brand: "puma" as BrandId,
    lat: -34.5571,
    lng: -58.4593,
  },
  {
    name: "YPF - Av. Rivadavia 6700",
    brand: "ypf" as BrandId,
    lat: -34.6282,
    lng: -58.4468,
  },
  {
    name: "Shell - Av. Callao 1200",
    brand: "shell" as BrandId,
    lat: -34.5995,
    lng: -58.3927,
  },
  {
    name: "Axion - Av. Corrientes 5500",
    brand: "axion" as BrandId,
    lat: -34.6052,
    lng: -58.4352,
  },
  {
    name: "Puma - Av. Juan B. Justo 3800",
    brand: "puma" as BrandId,
    lat: -34.6089,
    lng: -58.4515,
  },
      ...
      .forEach((s) => {
        ...
        const icon = L.divIcon({
          ...
          html:
            ...
            ";color:" +
            text +
            ';font:700 12px Archivo,sans-serif;padding:4px 9px;border-radius:7px;white-space:nowrap;">$' +
        ...
        marker.bindPopup(
          '<div style="font-family:Archivo,sans-serif;font-size:12px;line-height:1.6;min-width:180px;padding:4px 2px;">' +
            ...
            '<span style="font-size:22px;font-weight:800;color:' +
            color +
            ';">$' +
            price.toLocaleString("es-AR") +
            "</span>" +
