...
export default function MiniTrend() {
  ...
  if (values.length < 2) return <div className="bg-white dark:bg-dark-card rounded-xl border border-surface-200 dark:border-dark-border p-4 text-sm text-zinc-500">La tendencia semanal estará disponible al acumular historial oficial suficiente.</div>;
